...
BLOOP   
    ...
    BNE BLOOP; goes back to TOP TO CHECK IF BUTTON IS PRESSED
			
WinWIPE	
	MOV R2, #0
	MOV R4, #206; number of steps motor needs to go n order to go 145 degrees
WINLOOPF		;LOOPS UNTIL GOES ALL THE WAYS FORWARD
	ADD R2, #1; INCRIMENTS BY ONE SHOULD DO THIS LOOP 0 - 1150
	BAL fowFS; BRANCHES TO DO ONE FULL STEP
RETLOOPF
...
WINLOOPB		;LOOPS UNTIL GOES ALL THE WAY BACKWARDS
	...
	BAL bacFS;  BRANCHES TO DO ONW FULL STEP BACKWARDS
